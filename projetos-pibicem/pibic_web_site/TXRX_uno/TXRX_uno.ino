...
void setup() {
  ...
  mrf.reset();
  mrf.init();
  mrf.set_channel(20);  // Butado por nóis
  mrf.set_pan(0xcafe);
...
String TemperaturaHumidade(){
    sensor.read(5);
    String humidade = sensor.humidity;
    String temperatura = sensor.temperature;
